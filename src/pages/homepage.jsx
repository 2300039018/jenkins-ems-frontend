...
const HomePage = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    if (credentials.role === "admin") {
      url = "http://localhost:9090/api/admins/login";
    } else if (credentials.role === "employee") {
      url = "http://localhost:9090/api/employees/login";
    } else if (credentials.role === "hr") {
      url = "http://localhost:9090/api/hr/login";
    }
  ...
  const handleSignupSubmit = async (e) => {
    ...
    if (signupData.role === "admin") {
      url = "http://localhost:9090/api/admins/create";
    } else if (signupData.role === "employee") {
      url = "http://localhost:9090/api/employees/create";
    } else if (signupData.role === "hr") {
      url = "http://localhost:9090/api/hr/create";
    }
